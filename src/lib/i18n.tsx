...
const dict = {
  en: {
    ...
    save: 'Save',
    saving: 'Saving…',
    saveFailed: 'Could not save. Something went wrong — please try again.',
    delete: 'Delete',
    edit: 'Edit',
    close: 'Close',
    // calendar
    ...
    confirmSave: 'Save changes to this event?',
  ...
  zh: {
    ...
    confirmDelete: '要刪除這個事件嗎？',
    confirmSave: '要儲存這個事件的修改嗎？',
    avatarColor: '頭像顏色',
    changeAvatar: '更改頭像',
    editModeNormal: '普通修改',
    editModeForced: '強行修改',
